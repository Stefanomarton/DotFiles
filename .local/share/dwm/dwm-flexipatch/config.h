...
#if BAR_PANGO_PATCH
static const char font[]                 = "JetBrainsMono Nerd Font Mono 12";
#else
...
static char titleselbgcolor[]            = "#8FBCBB";
...
static char tagsselbgcolor[]             = "#8FBCBB";
...
const char *spcmd1[] = {"kitty", "--class", "term", "-o", "initial_window_width=300", NULL };
const char *spcmd2[] = {"kitty", "--class", "rng", "-o", "initial_window_width=300", "-e", "ranger", NULL };
const char *spcmd3[] = {"kitty", "--class", "spot", "-o", "initial_window_width=300", "-e", "ncspot",  NULL };
...
static const Rule rules[] = {
	...
	RULE(.instance = "rng", .tags = SPTAG(1), .isfloating = 1)
	RULE(.instance = "spot", .tags = SPTAG(2), .isfloating = 1)
	#endif // SCRATCHPADS_PATCH
};
...
static const MonitorRule monrules[] = {
	...
	{  0,      1,    1,      -1,    -1,      0,      0     }, // use a different layout for the second monitor
	{  0,      2,    2,      -1,    -1,      0,      0     }, // use a different layout for the second monitor
	{  1,      1,    2,      -1,    -1,      0,      0     }, // default
	{  -1,     1,    0,      -1,    -1,      0,      0     }, // default
};
#else
static const MonitorRule monrules[] = {
	/* monitor  layout  mfact  nmaster  showbar  topbar */
	{  0,       2,      -1,    -1,      0,      0     }, // use a different layout for the second monitor
	{  1,       2,      -1,    -1,      0,      0    }, // use a different layout for the second monitor
	{  -1,      0,      -1,    -1,      0,      0     }, // default
};
#endif // PERTAG_PATCH
...
static const BarRule barrules[] = {
	...
	#if BAR_TAGS_PATCH
	{ 0,        0,     BAR_ALIGN_LEFT,   width_tags,               draw_tags,              click_tags,              hover_tags,              "tags" },
	#endif // BAR_TAGS_PATCH
	#if BAR_TAGLABELS_PATCH
	{ 0,        0,     BAR_ALIGN_LEFT,   width_taglabels,          draw_taglabels,         click_taglabels,         NULL,                    "taglabels" },
	#endif // BAR_TAGLABELS_PATCH
	#if BAR_TAGGRID_PATCH
	{ 0,        0,     BAR_ALIGN_LEFT,   width_taggrid,            draw_taggrid,           click_taggrid,           NULL,                    "taggrid" },
	#endif // BAR_TAGGRID_PATCH
	#if BAR_SYSTRAY_PATCH
...
// TODO keybindings for empty tags
...
static const Key keys[] = {
	...
	// { MODKEY,                       XK_,          setlayout,              {.v = &layouts[1]} },
	...
	{ MODKEY|ControlMask,           XK_a,      setscratch,             {.ui = 1 } },
	{ MODKEY|ShiftMask,             XK_a,      removescratch,          {.ui = 1 } },
	{ MODKEY,                       XK_e,      togglescratch,          {.ui = 2 } },
	{ MODKEY|ControlMask,           XK_e,      setscratch,             {.ui = 2 } },
	{ MODKEY|ShiftMask,             XK_e,      removescratch,          {.ui = 2 } },
