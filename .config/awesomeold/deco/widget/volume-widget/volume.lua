...
local utils = require("deco.widget.volume-widget.utils")
...
local widget_types = {
    icon_and_text = require("deco.widget.volume-widget.widgets.icon-and-text-widget"),
    icon = require("deco.widget.volume-widget.widgets.icon-widget"),
    arc = require("deco.widget.volume-widget.widgets.arc-widget"),
    horizontal_bar = require("deco.widget.volume-widget.widgets.horizontal-bar-widget"),
    vertical_bar = require("deco.widget.volume-widget.widgets.vertical-bar-widget")
}
local volume = {}
