...
describe('YAML CodeLens', () => {
    ...
    it('should provides CodeLens with jumpToSchema command', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const result = yield codeLens.getCodeLens(doc);
    ...
    it('should place one CodeLens at beginning of the file for multiple documents', () => __awaiter(void 0, void 0, void 0, function* () {
        const doc = (0, testHelper_1.setupTextDocument)('foo: bar\n---\nfoo: bar');
        const schema = {
            url: 'some://url/to/schema.json',
        };
