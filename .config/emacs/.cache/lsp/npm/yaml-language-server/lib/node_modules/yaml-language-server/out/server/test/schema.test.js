...
describe('JSON Schema', () => {
    ...
    describe('Test schema priority', function () {
        ...
        it('Modeline Schema takes precendence over all other schemas', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield languageService.doComplete(testTextDocument, vscode_languageserver_types_1.Position.create(0, 0), false);
        ...
        it('Default snippet with description', () => __awaiter(this, void 0, void 0, function* () {
            languageSettingsSetup.withSchemaFileMatch({
                fileMatch: ['test.yaml'],
                uri: testHelper_1.TEST_URI,
                priority: src_1.SchemaPriority.SchemaStore,
            ...
            const result = yield languageService.doComplete(testTextDocument, vscode_languageserver_types_1.Position.create(0, 5), false);
