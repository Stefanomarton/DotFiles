(function (factory) {
    ...
    class YAMLServerInit {
        ...
        connectionInitialized(params) {
            ...
            this.languageService = (0, yamlLanguageService_1.getLanguageService)(this.schemaRequestService, this.workspaceContext, this.connection, this.telemetry, this.yamlSettings, params.capabilities);
