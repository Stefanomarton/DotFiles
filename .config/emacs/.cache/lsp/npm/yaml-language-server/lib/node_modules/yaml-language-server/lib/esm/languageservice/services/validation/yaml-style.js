...
export class YAMLStyleValidator {
    ...
    validate(document, yamlDoc) {
        ...
        visit(yamlDoc.internalDocument, (key, node) => {
            var _a, _b;
            if (this.forbidMapping && isMap(node) && ((_a = node.srcToken) === null || _a === void 0 ? void 0 : _a.type) === 'flow-collection') {
            ...
            if (this.forbidSequence && isSeq(node) && ((_b = node.srcToken) === null || _b === void 0 ? void 0 : _b.type) === 'flow-collection') {
