...
describe('Auto Completion Tests', () => {
        ...
        describe('Array Specific Tests', function () {
            ...
            it('Array autocomplete without word on space before array symbol', (done) => {
                ...
                completion
                    .then(function (result) {
                    assert.equal(result.items.length, 1);
                    assert.deepEqual(result.items[0], (0, verifyError_1.createExpectedCompletion)('- (array item)', '- ', 2, 2, 2, 2, 9, 2, {
            ...
            it('Array autocomplete on empty node with array from schema', (done) => {
                ...
                completion
                    .then(function (result) {
                    assert.equal(result.items.length, 1);
                    assert.deepEqual(result.items[0], (0, verifyError_1.createExpectedCompletion)('- (array item)', '- ', 1, 0, 1, 0, 9, 2, {
                        documentation: { kind: 'markdown', value: 'Create an item of an array\n ```\n- \n```' },
                    }));
                })
                    .then(done, done);
            ...
            it('Autocompletion after array with depth - indent', (done) => {
                ...
                completion
                    .then(function (result) {
                    assert.equal(result.items.length, 1);
                    assert.deepEqual(result.items[0], (0, verifyError_1.createExpectedCompletion)('- (array item)', '- name: ${1:test}', 3, 4, 3, 5, 9, 2, {
                        documentation: { kind: 'markdown', value: 'Create an item of an array\n ```\n- name: test\n```' },
                    }));
                })
                    .then(done, done);
    ...
    describe('Parent Completion', () => {
        ...
        it('Should not agregate suggested text from different schemas', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            (0, chai_1.expect)(result.items[1]).to.deep.equal(result.items[3]);
        }));
