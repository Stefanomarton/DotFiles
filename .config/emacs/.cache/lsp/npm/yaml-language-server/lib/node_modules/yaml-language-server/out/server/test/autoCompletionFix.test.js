...
`; // len: 42
    ...
    it('Autocomplete indent on array object when parent is array of an array', () => __awaiter(void 0, void 0, void 0, function* () {
        languageService.addSchema(testHelper_1.SCHEMA_ID, {
            type: 'object',
            properties: {
                array1: {
    ...
    describe('merge properties from anyOf objects', () => {
        ...
        it('Autocomplete should not suggest items for parent object', () => __awaiter(void 0, void 0, void 0, function* () {
            languageService.addSchema(testHelper_1.SCHEMA_ID, {
                type: 'object',
                properties: {
                    scripts: {
            ...
            const completion = yield parseSetup(content, 0, 9); // before line brake
            (0, chai_1.expect)(completion.items.length).equal(0);
        }));
        it('autoCompletion when value is null inside anyOf object', () => __awaiter(void 0, void 0, void 0, function* () {
            const schema = {
                anyOf: [
                    {
                        properties: {
    ...
    describe('extra space after cursor', () => {
        ...
        it('array completion - should suggest correct indent when extra spaces after cursor', () => __awaiter(void 0, void 0, void 0, function* () {
            languageService.addSchema(testHelper_1.SCHEMA_ID, {
                type: 'object',
                properties: {
                    test: {
            ...
            const content = 'test:\n  -               ';
            const result = yield parseSetup(content, 1, 4);
            (0, chai_1.expect)(result.items.length).to.be.equal(1);
            (0, chai_1.expect)(result.items[0].insertText).to.be.equal('objA:\n    itemA: ');
        }));
        it('array of arrays completion - should suggest correct indent when extra spaces after cursor', () => __awaiter(void 0, void 0, void 0, function* () {
            languageService.addSchema(testHelper_1.SCHEMA_ID, {
                type: 'object',
                properties: {
                    array1: {
        ...
        it('object of array of arrays completion - should suggest correct indent when extra spaces after cursor', () => __awaiter(void 0, void 0, void 0, function* () {
            languageService.addSchema(testHelper_1.SCHEMA_ID, {
                type: 'object',
                properties: {
                    array1: {
            ...
            const content = 'array1:\n  - array2:\n      -               ';
            const result = yield parseSetup(content, 2, 8);
            (0, chai_1.expect)(result.items.length).to.be.equal(1);
            (0, chai_1.expect)(result.items[0].insertText).to.be.equal('objA:\n    itemA: ');
        }));
