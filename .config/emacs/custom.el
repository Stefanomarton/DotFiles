(custom-set-variables
 ...
 '(helm-source-names-using-follow
	 '("Grep"
		 #("argv: /usr/bin/rg --smart-case --color=ansi --colors=match:fg:red --colors=match:style:bold font" 6 17
		 ...
		 "RG" "Project buffers" "describe-variable" "Projectile" "Projectile files")))
(custom-set-faces
