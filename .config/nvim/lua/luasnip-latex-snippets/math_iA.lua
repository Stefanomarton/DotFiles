...
local math_iA = {
  ...
  ls.parser.parse_snippet({ trig = "ch ", name = "to the ... power ^{}" }, "\\chi "),
  ls.parser.parse_snippet({ trig = "ga ", name = "to the ... power ^{}" }, "\\gamma "),
  ls.parser.parse_snippet({ trig = "Ga ", name = "to the ... power ^{}" }, "\\Gamma "),
  ls.parser.parse_snippet({ trig = "de ", name = "to the ... power ^{}" }, "\\delta "),
  ls.parser.parse_snippet({ trig = "De ", name = "to the ... power ^{}" }, "\\Delta "),
  ls.parser.parse_snippet({ trig = "ep ", name = "to the ... power ^{}" }, "\\epta "),
  ls.parser.parse_snippet({ trig = "ze ", name = "to the ... power ^{}" }, "\\zeta "),
  ls.parser.parse_snippet({ trig = "th ", name = "to the ... power ^{}" }, "\\theta "),
  ls.parser.parse_snippet({ trig = "Th ", name = "to the ... power ^{}" }, "\\Theta "),
  ls.parser.parse_snippet({ trig = "ka ", name = "to the ... power ^{}" }, "\\ka "),
  ls.parser.parse_snippet({ trig = "la ", name = "to the ... power ^{}" }, "\\lamda "),
  ls.parser.parse_snippet({ trig = "La ", name = "to the ... power ^{}" }, "\\Lamda "),
  ls.parser.parse_snippet({ trig = "rh ", name = "to the ... power ^{}" }, "\\rho "),
  ls.parser.parse_snippet({ trig = "si ", name = "to the ... power ^{}" }, "\\sigma "),
  ls.parser.parse_snippet({ trig = "Si ", name = "to the ... power ^{}" }, "\\Sigma "),
