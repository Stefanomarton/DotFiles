...
_G.packer_plugins = {
  ...
  ["fidget.nvim"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/stefanomarton/.local/share/nvim/site/pack/packer/opt/fidget.nvim",
  ...
  ["noice.nvim"] = {
    ...
    loaded = true,
    only_config = true,
    path = "/home/stefanomarton/.local/share/nvim/site/pack/packer/start/noice.nvim",
...
try_loadstring("\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\20user.deco.noice\frequire\0", "config", "noice.nvim")
