...
vim.cmd [[au FileType tex ++once lua require("packer.load")({'cmp-latex-symbols', 'telescope-heading.nvim', 'vimtex'}, { ft = "tex" }, _G.packer_plugins)]]
