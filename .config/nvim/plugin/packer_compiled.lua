...
vim.cmd [[au FileType tex ++once lua require("packer.load")({'cmp-latex-symbols', 'telescope-heading.nvim', 'tex-conceal.vim'}, { ft = "tex" }, _G.packer_plugins)]]
