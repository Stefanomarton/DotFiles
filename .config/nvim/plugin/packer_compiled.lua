...
_G.packer_plugins = {
  ...
  ["lightspeed.nvim"] = {
    loaded = true,
    path = "/home/stefanomarton/.local/share/nvim/site/pack/packer/start/lightspeed.nvim",
  ...
  ["tex-conceal.vim"] = {
    loaded = true,
    path = "/home/stefanomarton/.local/share/nvim/site/pack/packer/start/tex-conceal.vim",
