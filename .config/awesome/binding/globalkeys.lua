...
function _M.get()
	local globalkeys = gears.table.join(
		...
		awful.key({ modkey, "Shift" }, "q", function()
			logout_popup.launch()
		end, { description = "Logout_Menu", group = "awesome" }),
		...
		awful.key({ modkey }, "s", function()
			awful.util.spawn("rofi -show drun -theme ~/.config/rofi/dracula.rasi")
		end, { description = "show the menubar", group = "launcher" }),

		-- Scratchpad
		awful.key({ modkey }, "u", function()
			term_scratch:toggle()
		end, { description = "Ranger", group = "Scratchpad" }),
		awful.key({ modkey }, "t", function()
			term:toggle()
		end, { description = "Term", group = "Scratchpad" }),
		awful.key({ modkey }, "/", function()
			mixer:toggle()
		end, { description = "Mixer", group = "Scratchpad" }),
		awful.key({ modkey }, "g", function()
			galculator:toggle()
		end, { description = "Galculator", group = "Scratchpad" }),
		awful.key({ modkey }, "y", function()
			ytm:toggle()
		end, { description = "YTMusic", group = "Scratchpad" }),
		...
		awful.key({ modkey, "Control" }, "l", function()
			awful.spawn.with_shell("/bin/bash -c /home/stefanomarton/Scripts/libriv2")
		end, { description = "open book", group = "Scripts" })
	)
